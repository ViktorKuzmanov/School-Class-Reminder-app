...
//
//  Created by Viktor Kuzmanov on 1/10/18.
//
...
class FirstWalkthroughController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        // MARK: Da se add drug kod tuka namesto cancelWalkthorug func drugo treba
        ...
        if pageControl.currentPage == pages.count - 1 {
            ...
            buttonNext.addTarget(self, action: #selector(presentTabBarController), for: .touchUpInside) // na fishish kopceto mu daame action da ispadne
        }
        // ako e na predposlednata strana pa da bide next za da moze da otide na poslednata
        if pageControl.currentPage == pages.count - 2 {
            buttonNext.removeTarget(self, action: #selector(presentTabBarController), for: .touchUpInside)
    ...
    @objc private func handlePrevious() {
        ...
        // ne ni treba "PREV" ili "BACK" naslov na button ako e na prvata strana
        if nextIndex == 0 {
            buttonPrevious.setTitle("", for: .normal)
        }
...
//        performSegue(withIdentifier: "WalkthroughSegue", sender: buttonNext)
        
        let mainST2 = UIStoryboard(name: "Main", bundle: Bundle.main)
        let VC2 = mainST2.instantiateViewController(withIdentifier: "TabBar39")
        present(VC2, animated: true, completion: nil)
        
//        let mainST = UIStoryboard(name: "Main", bundle: Bundle.main)
//        let VC = mainST.instantiateViewController(withIdentifier: "NavigationController1")
